...
public class FragmentRecordCultivatePhoto extends Fragment {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what)
            {
                case GET_IMAGE_PATH_SUCCEED:
                    ...
                    {
                        Toast.makeText(getContext(), "无基物照片", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_record_cultivate_photo, container, false);
    }
    ...
    private void initView()
    {
        ...
        photo1 = (getActivity()).findViewById(R.id.record_cultivate1);
        photo2 = (getActivity()).findViewById(R.id.record_cultivate2);
        photo3 = (getActivity()).findViewById(R.id.record_cultivate3);
        photo4 = (getActivity()).findViewById(R.id.record_cultivate4);
        photo5 = (getActivity()).findViewById(R.id.record_cultivate5);
        photo6 = (getActivity()).findViewById(R.id.record_cultivate6);
        photo7 = (getActivity()).findViewById(R.id.record_cultivate7);
        photo8 = (getActivity()).findViewById(R.id.record_cultivate8);
        photo9 = (getActivity()).findViewById(R.id.record_cultivate9);
