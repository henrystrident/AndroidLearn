...
public class FragmentEnvironmentPhoto extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_environment_photo, container, false);
    }
    ...
    {
        shot = (getActivity()).findViewById(R.id.takeEnvironmentPhoto);
        shot.setOnClickListener(this);
        
        photo1 = (getActivity()).findViewById(R.id.environment1);
        photo2 = (getActivity()).findViewById(R.id.environment2);
        photo3 = (getActivity()).findViewById(R.id.environment3);
        photo4 = (getActivity()).findViewById(R.id.environment4);
        photo5 = (getActivity()).findViewById(R.id.environment5);
        photo6 = (getActivity()).findViewById(R.id.environment6);
        photo7 = (getActivity()).findViewById(R.id.environment7);
        photo8 = (getActivity()).findViewById(R.id.environment8);
        photo9 = (getActivity()).findViewById(R.id.environment9);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.takeEnvironmentPhoto:
                if (pathMap.size() == 9)
                {
