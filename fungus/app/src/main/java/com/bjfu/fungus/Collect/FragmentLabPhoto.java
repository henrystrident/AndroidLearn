...
public class FragmentLabPhoto extends Fragment implements View.OnClickListener{
    ...
    {
        shot = (getActivity()).findViewById(R.id.takeLabPhoto);
        shot.setOnClickListener(this);

        photo1 = (getActivity()).findViewById(R.id.lab1);
        photo2 = (getActivity()).findViewById(R.id.lab2);
        photo3 = (getActivity()).findViewById(R.id.lab3);
        photo4 = (getActivity()).findViewById(R.id.lab4);
        photo5 = (getActivity()).findViewById(R.id.lab5);
        photo6 = (getActivity()).findViewById(R.id.lab6);
        photo7 = (getActivity()).findViewById(R.id.lab7);
        photo8 = (getActivity()).findViewById(R.id.lab8);
        photo9 = (getActivity()).findViewById(R.id.lab9);
