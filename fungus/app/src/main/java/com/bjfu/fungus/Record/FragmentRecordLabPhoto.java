...
public class FragmentRecordLabPhoto extends Fragment {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what)
            {
                case GET_IMAGE_PATH_SUCCEED:
                    ...
                    {
                        Toast.makeText(getContext(), "无实验室照片", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_record_lab_photo, container, false);
    }
    ...
    private void initView()
    {
        ...
        photo1 = (getActivity()).findViewById(R.id.record_lab1);
        photo2 = (getActivity()).findViewById(R.id.record_lab2);
        photo3 = (getActivity()).findViewById(R.id.record_lab3);
        photo4 = (getActivity()).findViewById(R.id.record_lab4);
        photo5 = (getActivity()).findViewById(R.id.record_lab5);
        photo6 = (getActivity()).findViewById(R.id.record_lab6);
        photo7 = (getActivity()).findViewById(R.id.record_lab7);
        photo8 = (getActivity()).findViewById(R.id.record_lab8);
        photo9 = (getActivity()).findViewById(R.id.record_lab9);
