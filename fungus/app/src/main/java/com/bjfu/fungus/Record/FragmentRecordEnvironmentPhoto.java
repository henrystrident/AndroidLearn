...
public class FragmentRecordEnvironmentPhoto extends Fragment {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what)
            {
                case GET_IMAGE_PATH_SUCCEED:
                    if (msg.obj == null)
                    {
                        Toast.makeText(getContext(), "无生境照片", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_record_environment_photo, container, false);
    }
    ...
    private void initView()
    {
        ...
        photo1 = (getActivity()).findViewById(R.id.record_environment1);
        photo2 = (getActivity()).findViewById(R.id.record_environment2);
        photo3 = (getActivity()).findViewById(R.id.record_environment3);
        photo4 = (getActivity()).findViewById(R.id.record_environment4);
        photo5 = (getActivity()).findViewById(R.id.record_environment5);
        photo6 = (getActivity()).findViewById(R.id.record_environment6);
        photo7 = (getActivity()).findViewById(R.id.record_environment7);
        photo8 = (getActivity()).findViewById(R.id.record_environment8);
        photo9 = (getActivity()).findViewById(R.id.record_environment9);
