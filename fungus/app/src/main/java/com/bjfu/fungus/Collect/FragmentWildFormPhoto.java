...
public class FragmentWildFormPhoto extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_wild_form_photo, container, false);
    }
    ...
    {
        shot = (getActivity()).findViewById(R.id.takeWildFormPhoto);
        shot.setOnClickListener(this);

        photo1 = (getActivity()).findViewById(R.id.wildForm1);
        photo2 = (getActivity()).findViewById(R.id.wildForm2);
        photo3 = (getActivity()).findViewById(R.id.wildForm3);
        photo4 = (getActivity()).findViewById(R.id.wildForm4);
        photo5 = (getActivity()).findViewById(R.id.wildForm5);
        photo6 = (getActivity()).findViewById(R.id.wildForm6);
        photo7 = (getActivity()).findViewById(R.id.wildForm7);
        photo8 = (getActivity()).findViewById(R.id.wildForm8);
        photo9 = (getActivity()).findViewById(R.id.wildForm9);
